        ...
        <>
          ...
          <div className="px-4 pb-2">
            <button
              ...
              className="w-full py-1.5 text-sm text-slate-400 hover:text-orange-500 hover:bg-slate-700/50 rounded-lg transition-colors flex items-center justify-center gap-1.5"
            >
                  ...
                  {editingChatId === chat.id ? (
                    ...
                    <div className="flex items-center">
                      <button
                        ...
                        className="flex-1 text-left p-2 pr-12 min-w-0"
                      >
