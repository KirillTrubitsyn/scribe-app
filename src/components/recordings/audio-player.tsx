    ...
    <div className="bg-slate-800/50 rounded-xl p-2 border border-slate-700/50">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 flex items-center gap-2">
          ...
          <div
            ref={progressRef}
            className="flex-1 h-1.5 bg-slate-700 rounded-full cursor-pointer group relative"
          ...
          >
            ...
            <div
              className={cn(
                "absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow-md",
...
export function AudioPlayerPlaceholder({
  ...
  return (
    <div className="bg-slate-800/50 rounded-xl p-2 border border-slate-700/50 text-center">
      <p className="text-slate-400 py-2 text-sm">{message}</p>
    </div>
  );
}
